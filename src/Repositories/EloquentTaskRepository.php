...
class EloquentTaskRepository implements TaskInterface
{
    ...
    public function execute($id)
    {
        ...
        try {
            ...
            file_put_contents(config('totem.log_path').DIRECTORY_SEPARATOR.$task->getMutexName(), Artisan::output());
        } catch (\Exception $e) {
            file_put_contents(config('totem.log_path').DIRECTORY_SEPARATOR.$task->getMutexName(), $e->getMessage());
        }
